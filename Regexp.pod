...
=head2 Predefined Character Classes
   ...
   \p{Punct}      \pP        [[:punct:]]       [!-/:-@[-`{-~\xA1-\xA5\x{8141}-\x{8149}\x{814C}-\x{8151}\x{815C}-\x{81AC}\x{81B8}-\x{81BF}\x{81C8}-\x{81CE}\x{81DA}-\x{81E8}\x{81F0}-\x{81F7}\x{81FC}\x{849F}-\x{84BE}]
 ...
 ( \p{^Zenkaku}   \p^Z       [[:^zenkaku:]]    [\x00-\x7F\xA1-\xDF] )
   ...
   \p{Fullwidth}  \pF        [[:fullwidth:]]   [\x{8149}\x{8194}\x{8190}\x{8193}\x{8195}\x{8169}\x{816A}\x{8196}\x{817B}\x{8143}\x{8144}\x{815E}\x{824F}-\x{8258}\x{8146}\x{8147}\x{8183}\x{8181}\x{8184}\x{8148}\x{8197}\x{8260}-\x{8279}\x{816D}\x{818F}\x{816E}\x{814F}\x{8151}\x{814D}\x{8281}-\x{829A}\x{816F}\x{8162}\x{8170}\x{8150}]

   \p{X0201}                 [[:x0201:]]       [\x20-\x7F\xA1-\xDF]
   \p{X0208}                 [[:x0208:]]       [\x{8140}-\x{81AC}\x{81B8}-\x{81BF}\x{81C8}-\x{81CE}\x{81DA}-\x{81E8}\x{81F0}-\x{81F7}\x{81FC}\x{824F}-\x{8258}\x{8260}-\x{8279}\x{8281}-\x{829A}\x{829F}-\x{82F1}\x{8340}-\x{8396}\x{839F}-\x{83B6}\x{83BF}-\x{83D6}\x{8440}-\x{8460}\x{8470}-\x{8491}\x{849F}-\x{84BE}\x{889F}-\x{9872}\x{989F}-\x{EAA4}]
...
that does not match any one Shift-JIS character,
